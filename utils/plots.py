...
class Annotator:
    ...
    def draw_id(self, bbox, identities=None, categories=None, names=None, offset=(0, 0)):
        ...
        #center_and_id.append(centers)
        #center_and_id.append(ids)
    ...
    def draw_counting(self,up_line_pt_1,up_line_pt_2,down_line_pt_1,down_line_pt_2,width_img,height_img,vehicle_up_count,vehicle_down_count):
        color = (0,255,0)
        thickness = 1
        fontWidth=100
        fontScale=0.5
        # self.get_optimal_font_scale('Vehicle Up = '+str(vehicle_up_count),fontWidth)
        font = cv2.FONT_HERSHEY_SIMPLEX
        offset_h=-45
        offset_v=+20
        org_up = ((3*width_img // 4)+offset_h, ((2 * height_img) // 3)+offset_v)
        org_down = ((width_img // 4)+offset_h, ((2 * height_img) // 3)+offset_v)
        cv2.line(self.im,up_line_pt_1,up_line_pt_2,color=(0,255,0),thickness=1)
        cv2.line(self.im,down_line_pt_1,down_line_pt_2,color=(255,0,0),thickness=1)
        cv2.putText(self.im, 'Vehicle Up = '+str(vehicle_up_count), org_up, font, fontScale, color, thickness, cv2.LINE_AA)
        cv2.putText(self.im, 'Vehicle Down = '+str(vehicle_down_count), org_down, font, fontScale, (0,0,255), thickness, cv2.LINE_AA)
